  ...
  return (
    <section id="structures" className="mx-auto max-w-6xl scroll-mt-20 px-5 py-20">
      <div className="mx-auto max-w-2xl text-center">
        <p className="text-sm font-semibold text-brand-strong">Every structure, drawn as itself</p>
        <h2 className="mt-2 text-balance text-3xl font-semibold tracking-tight text-fg sm:text-4xl">
      ...
      <div className="mt-14 flex flex-col items-center gap-3">
        ...
        <Link
          href="/learn"
          className="group inline-flex items-center gap-2 rounded-full border border-line-strong bg-surface px-5 py-2.5 text-sm font-medium text-fg transition-colors hover:border-brand hover:text-brand-strong"
        >
          Explore the map
