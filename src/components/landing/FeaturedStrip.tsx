  ...
  return (
    <section className="mx-auto max-w-6xl px-5 pb-8">
      <div className="mb-5 flex items-end justify-between">
        ...
        <Link href="/problems" className="text-sm font-medium text-fg-muted transition-colors hover:text-brand-strong">
          Browse all →
        </Link>
      </div>
          ...
          >
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                ...
                <ArrowUpRight className="size-3.5 shrink-0 text-fg-faint transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-brand-strong" />
              </div>
